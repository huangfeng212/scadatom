...
import io.scadatom.electron.config.audit.AuditEventConverter;
import io.scadatom.electron.domain.PersistentAuditEvent;
...
import static io.scadatom.electron.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
