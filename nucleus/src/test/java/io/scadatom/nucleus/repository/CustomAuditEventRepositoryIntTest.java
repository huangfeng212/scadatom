...
import io.scadatom.nucleus.config.audit.AuditEventConverter;
import io.scadatom.nucleus.domain.PersistentAuditEvent;
...
import static io.scadatom.nucleus.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
